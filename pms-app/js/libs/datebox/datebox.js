...
define([
	'../js/libs/datebox/extend',
	'../js/libs/datebox/DateTime',
	'../js/libs/datebox/MonthComponent',
	'../js/libs/datebox/DateComponent',
	'../js/libs/datebox/HourComponent',
	'../js/libs/datebox/hasEle',
	'../js/libs/datebox/clearFix',
	'../js/libs/datebox/defaultOpts'
],function(
	extend,
	DateTime,
	MonthComponent,
	...
	//初始化样式
	DateBox.prototype.setPosition = function(){	
		var bs = this.box.style;
		var offset=document.documentElement.scrollTop;
		bs.top = (this.obj.getBoundingClientRect().bottom+offset) + 'px';

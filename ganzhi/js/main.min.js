...
}map.clearOverlays();var g=["超市","集贸"];if(i==null){i=g;}var c,f,h;var h=0;var d=new BMap.Geocoder();d.getPoint(e,function(j){if(j){map.centerAndZoom(j,15);
map.addOverlay(new BMap.Marker(j));c=new BMap.Circle(j,b,{fillColor:"blue",strokeWeight:1,fillOpacity:0.3,strokeOpacity:0.3});map.addOverlay(c);f=new BMap.LocalSearch(map,{renderOptions:{map:map,panel:a,autoViewport:false},onSearchComplete:function(o){console.log(o);
var m="";if(i==g){for(var n=0;n<o.length;n++){h+=o[n].getNumPois();}m+='<div class="searchSort" id="searchSort"><span id="marketBtn"><span class="marketSUM">'+o[0].getNumPois()+'</span><span class="stext">超市</span></span><span id="foodmarketBtn"><span class="foodmarketSUM">'+o[1].getNumPois()+'</span><span class="stext">菜场</span></span></div>';

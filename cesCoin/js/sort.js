...
$(function(){
		...
		$(".sort_list").click(function(){
			var _this=$(this);
			var userName = encodeURIComponent(_this.find(".num_name").html());
			var phone = encodeURIComponent(_this.find(".num_name").data("phone"));
			window.location.href='transerCoin.html?user='+userName+'&phone='+phone+'';
		});
